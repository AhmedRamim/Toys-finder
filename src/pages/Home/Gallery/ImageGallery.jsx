  ...
  return (
    <div>
      <h1 data-aos="fade-right"
        ...
        data-aos-duration="2000" className='text-center font-bold text-5xl text-gray-600 mt-40 mb-12'>Our Latest Collection</h1>
      <div className='md:flex items-center p-5 md:p-0 gap-10'>
        ...
        <div data-aos="fade-down"
          ...
          data-aos-duration="2000" className="gallery md:w-1/2 text-center overflow-hidden  h-[700px] flex items-center ">
